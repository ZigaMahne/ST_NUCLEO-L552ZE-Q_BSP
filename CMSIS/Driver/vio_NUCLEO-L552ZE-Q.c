/******************************************************************************
 * @file     vio_NUCLEO-L552ZE-Q.c
 * @brief    Virtual I/O implementation for board NUCLEO-L552ZE-Q
 * @version  V2.0.0
...
/*! \page vio_NUCLEO-L552ZE-Q Physical I/O Mapping
...
| vioLED0       | vioSignalOut.0 | LED red     (LD3)    | PA9
| vioLED1       | vioSignalOut.1 | LED green   (LD1)    | PC7
...
//  signal,     pin,                   pull resistor,      active state
  { vioLED0,    GPIO_PIN_ID_PORTA(9),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH },
  { vioLED1,    GPIO_PIN_ID_PORTC(7),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH },
